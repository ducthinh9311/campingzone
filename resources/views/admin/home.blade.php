            ...
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <div class="page-title-right">
                        <!-- <ol class="breadcrumb m-0"> -->
                            <!-- <li class="breadcrumb-item active" aria-current="page"> -->
                                <label for="select-statistic"> Thống kê theo
                                    
                                </label>
                                <form id="form-statistic" method="get" class="d-flex" action="{{route('admin.home')}}">
                                    <select id="select-statistic" name="statistic" class="form-control">
                                        <option value="day" @if(isset($_REQUEST['statistic']) &&$_REQUEST['statistic'] == 'day' || !isset($_REQUEST['statistic'])) selected="selected" @endif>Ngày</option>
                                        <option value="month" @if(isset($_REQUEST['statistic']) && $_REQUEST['statistic'] == 'month') selected="selected" @endif>Tháng</option>
                                    </select>
                                    @if(isset($_REQUEST['statistic']) && $_REQUEST['statistic'] == 'day' || !isset($_REQUEST['statistic']))
                                        <div class="d-flex align-center" style="margin-left:16px;">
                                            <input type="date" id="start_date" value="{{$start_date}}" name="start_date" class="form-control">
                    ...
                    <div class="col-md-2">
                        <div class="card mini-stats-wid">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium text-uppercase">Tổng đơn hàng</p>
                                        <h4 class="mb-0">{{ $card['orderTotal'] ?? 0 }}</h4>
                                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="card mini-stats-wid">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium text-uppercase">Đơn hàng xử lý</p>
                                        <h4 class="mb-0">{{ $card['orderProcess'] ?? 0 }}</h4>
                                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            @if(isset($_REQUEST['statistic']) && $_REQUEST['statistic'] == 'month')
                            <label class="text-dark">Năm {{ \Carbon\Carbon::now()->year }}</label>
                            @else
                            <label class="text-dark">10 ngày gần đây</label>
                            @endif
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            @if(isset($_REQUEST['statistic']) && $_REQUEST['statistic'] == 'month')
                            <label class="text-dark">Tháng {{ \Carbon\Carbon::now()->format('m/Y') }}</label>
                            @else
                            <label class="text-dark">Ngày {{ \Carbon\Carbon::now()->format('d/m/Y') }}</label>
...
@section('admin_script')
    ...
    <script>
        $('#select-statistic').change(function(){
            $('#form-statistic').submit();
        })
    </script>
