...
@section('client_main')
                                        ...
                                        <div class="col-lg-7 col-9">
                                            <div class="banner_content overflow-hidden">
                                                ...
                                                <a class="btn btn-fill-out rounded-0 staggered-animation text-uppercase"
                                                    ...
                                                    data-animation="slideInLeft" data-animation-delay="1.5s"
                                                    target="{{ $banner['target'] }}">Xem ngay</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- END MAIN CONTENT -->
    <div class="main_content" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                        ...
                                        <ul class="nav nav-tabs justify-content-center justify-content-md-end"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="sellers-tab" data-toggle="tab" href="#sellers"
                                                    role="tab" aria-controls="sellers" aria-selected="false">Thuê
                                                    nhiều
                                                    Nhất</a>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="arrival" role="tabpanel"
                                        ...
                                        @if (isset($product_new) && count($product_new) > 0)
                                            <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1"
                                                ...
                                                data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "5"}}'>
                                                    ...
                                                    <div class="item">
                                                        <div class="product_wrap">
                                                            ...
                                                            <div class="product_img">
                                                                <a
                                                                    href="{{ route('client.product.show', ['slug' => $newProduct['slug']]) }}">
                                                                    <img src="{{ hwa_image_url('products/thumbs', $newProduct['thumb']) }}"
                                                                        alt="{{ $newProduct['name'] ?? '' }}">
                                                                    ...
                                                                    <ul class="list_none pr_action_btn">
                                                                        <li class="add-to-cart"><a
                                                                                href="{{ route('client.cart.create', $newProduct['id']) }}"><i
                                                                                    class="icon-basket-loaded"></i> Thêm
                                                                                vào
                                                                                giỏ hàng</a>
                                                                        </li>
                                                                        <li>
                                                                            <a
                                                                                href="{{ route('client.wishlist.store', ['id' => $newProduct['id']]) }}"><i
                                                            ...
                                                            <div class="product_info">
                                                                ...
                                                                <div class="product_price">
                                                                    <span
                                                                        class="price">{{ number_format($newProduct['price']) ?? 0 }}
                                                                        đ</span>
                                                                </div>
                                                                <div class="rating_wrap">
                                                                    <div class="rating">
                                                                        <div class="product_rate"
                                                                            style="width:{{ hwa_rating_percent($newProduct['id']) }}%">
                                                                        </div>
                                                                    </div>
                                                                    <span
                                                                        class="rating_num">({{ count($newProduct->reviews) ?? 0 }})</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                @foreach ($product_sale as $sale)
                                                    <div class="item">
                                                        <div class="product_wrap">
                                                            ...
                                                            <div class="product_img">
                                                                <a
                                                                    href="{{ route('client.product.show', ['slug' => $sale['slug']]) }}">
                                                                    <img src="{{ hwa_image_url('products/thumbs', $sale['thumb']) }}"
                                                                        alt="{{ $sale['name'] ?? '' }}">
                                                                    <img class="product_hover_img"
                                                                ...
                                                                <div class="product_action_box">
                                                                    <ul class="list_none pr_action_btn">
                                                                        ...
                                                                        <li>
                                                                            <a
                                                                                href="{{ route('client.wishlist.store', ['id' => $sale['id']]) }}"><i
                                                                                    class="icon-heart"></i></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            ...
                                                            <div class="product_info">
                                                                ...
                                                                <div class="product_price">
                                                                    <span class="price">{{ $sale['price'] ?? 0 }}
                                                                        đ</span>
                                                                </div>
                                                                <div class="rating_wrap">
                                                                    <div class="rating">
                                                                        <div class="product_rate"
                                                                            style="width:{{ hwa_rating_percent($sale['id']) }}%">
                                                                        </div>
                                                                    </div>
                                                                    <span
                                                                        class="rating_num">({{ count($sale->reviews) ?? 0 }})</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="heading_tab_header">
                                    ...
                                    <div class="view_all">
                                        <a href="{{ route('client.product.index') }}" class="text_default"><i
                                                class="linearicons-power"></i> <span>Xem thêm</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        @foreach ($product_trending as $trending)
                                            <div class="item">
                                                <div class="product_wrap">
                                                    ...
                                                    <div class="product_img">
                                                        <a
                                                            href="{{ route('client.product.show', ['slug' => $trending['slug']]) }}">
                                                            <img src="{{ hwa_image_url('products/thumbs', $trending['thumb']) }}"
                                                                alt="el_img2">
                                                            <img class="product_hover_img"
                                                        ...
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="{{ route('client.wishlist.store', ['id' => $trending['id']]) }}"><i
                                                                            class="icon-heart"></i></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="product_info">
                                                        ...
                                                        <div class="product_price">
                                                            <span
                                                                class="price">{{ number_format($trending['price']) ?? 0 }}
                                                                đ</span>
                                                        </div>
                                                        <div class="rating_wrap">
                                                            <div class="rating">
                                                                <div class="product_rate"
                                                                    style="width:{{ hwa_rating_percent($trending['id']) }}%">
                                                                </div>
                                                            </div>
                                                            <span
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="heading_tab_header">
                                    ...
                                    <div class="view_all">
                                        <a href="{{ route('client.news.index') }}" class="text_default"><span>Xem
                                                thêm</span></a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        @foreach ($news as $itemNews)
                                            <div class="col-lg-4 col-md-6">
                                                <div class="blog_post blog_style2 box_shadow1">
                                                    <div class="blog_img">
                                                        <a
                                                            href="{{ route('client.news.show', ['slug' => $itemNews['slug']]) }}">
                                                            <img src="{{ $itemNews['image'] ? hwa_image_url('news/thumb', $itemNews['image']) : 'assets/images/blog_small_img1.jpg' }}"
                                                                alt="{{ $itemNews['title'] ?? '' }}">
                                                        </a>
                                                    </div>
                                                    <div class="blog_content bg-white">
                                                        <div class="blog_text">
                                                            <h5 class="blog_title"><a
                                                                    href="{{ route('client.news.show', ['slug' => $itemNews['slug']]) }}">{{ $itemNews['title'] ?? '' }}</a>
                                                            </h5>
                                                            <ul class="list_none blog_meta">
                                                                <li><i class="ti-calendar"></i>
                                                                    {{ Carbon\Carbon::parse($itemNews['created_at'])->locale('vi')->isoFormat('MMM DD, Y') }}
                                                                </li>
                                                                <li><i class="ti-eye"></i>
                                                                    {{ number_format($itemNews['views']) ?? 0 }} Lượt
                                                                    xem</li>
                                                            </ul>
                    ...
                    <div class="col-lg-4">
                        <div class="icon_box icon_box_style1">
                            ...
                            <div class="icon_box_content">
                                <h5>Nhanh gọn</h5>
                                <p>Luôn hỗ trợ 1 cách nhanh nhất</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="icon_box icon_box_style1">
                            ...
                            <div class="icon_box_content">
                                ...
                                <p>Chỉ cần thông báo trước từ 1 ngày để chúng tôi có thể kịp thay đổi.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
