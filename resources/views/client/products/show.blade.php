                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="pr_detail">
                            <div class="product_description">
                                ...
                                <div class="product_sort_info">
                                    <ul>
                                        ...
                                        <li><i class="linearicons-sync"></i> Hoàn 90% nếu yêu cầu hủy trước 3 ngày</li>
                                        <li><i class="linearicons-bag-dollar"></i> Nhiều hình thức thanh toán</li>
                                    </ul>
                                </div>
                            </div>
                            @if($result['quantity'] > 0)
                            <div>Số lượng: {{$result['quantity']}} đôi</div>
                            @endif
                            <hr/>
                            @if($result['quantity'] > 0)
                            <form action="{{ route('client.cart.create',['id' => $result['id']])}}" method="post">
                                @csrf
                                <div class="cart_extra">
                                    ...
                                    <div class="cart_btn">
                                        <button class="btn btn-fill-out btn-addtocart text-white"><i
                            ...
                            <div class="cart_extra">
                                ...
                                <div class="cart_btn">
                                    <button class="btn btn-fill-out  text-white"> Hết hàng
                                    </button>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="comment_block">
                                                            ...
                                                            <p class="customer_meta">
                                                                ...
                                                                <span
                                                                    class="comment-date">{{ Carbon\Carbon::parse($review['created_at']) }}</span>
                                                            </p>
