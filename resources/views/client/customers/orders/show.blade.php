    ...
    <div class="tab-pane fade active show">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-5">
                    <div class="col-sm-6">
                        <img src="{{ hwa_setting('site_logo') ? hwa_image_url('system', hwa_setting('site_logo_dark')) : 'shopwise/assets/images/logo-camping.png' }}"
                            alt="logo" height="40" />
                    </div>
                                ...
                                @foreach ($result['order_details'] as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{ hwa_image_url('products/thumbs', $item['product']['thumb']) }}"
                                                alt="" height="100">
                                        </td>
                ...
                <div class="row d-flex justify-content-center mt-5">
                    <a href="{{ route("{$path}.export_detail", ['id' => $result['id']]) }}"
                        class="btn btn-fill-out btn-sm">Xuất hóa đơn</a>
                    @if (($result['active'] == 'pending' || $result['active'] == 'processing') && $result['payment_method'] == 'cod')
                        <a href="{{ route("{$path}.cancel", ['id' => $result['id']]) }}" class="btn btn-dark btn-sm">Hủy
                            đơn hàng</a>
                    @endif
                </div>
            </div>
