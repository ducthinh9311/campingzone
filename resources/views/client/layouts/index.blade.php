...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
        href="{{ !empty(hwa_setting('site_favicon')) ? hwa_image_url('system', hwa_setting('site_favicon')) : 'shopwise/assets/images/favicon.png' }}">
    <!-- Animation CSS -->
    ...
    <!-- Google Font -->
    <link href="https://fonts.googleapis.com/css?family=Roboto+Condensed:100,300,400,500,700,900&display=swap"
        rel="stylesheet">
